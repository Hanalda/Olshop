...
import nikeair from '../image/nikeair.jpg';
import puma from '../image/puma.jpg';
import puma222 from '../image/puma222.jpg';
import ProdukItem from '../client/ProdukItem';

export default class ProdukClient extends React.Component
{
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-3">
                        <h1 className="my-4">Reach Shopping</h1>
                        ...
                        <div id="slideshow" className="carousel slide my-4" data-ride="carousel">
                            ...
                            <div className="carousel-inner" role="listbox">
                                <div className="carousel-item active">
                                    <img className="d-block img-fluid" src={nikeair} alt="First slide" />
                                </div>
                                <div className="carousel-item">
                                    <img className="d-block img-fluid" src={puma} alt="Second Slide" />
                                </div>
                                <div className="carousel-item">
                                    <img className="d-block img-fluid" src={puma222} alt="Third Slide" />
                                </div>
                            </div>
